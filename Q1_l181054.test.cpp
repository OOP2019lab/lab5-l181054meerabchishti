...
void BankAccount::print(BankAccount member)
{
	cout<<"the account holder's name is:"<<member.holdername<<endl;
	cout<<"the account number is:"<<member.Accnumber<<endl;
	cout<<"the total number of transactions is:"<<member.currenttrans<<endl;
